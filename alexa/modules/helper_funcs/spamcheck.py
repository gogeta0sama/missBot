                    ...
                    if int(time) >= int(value['restrict']):
                         ...
                         if value['status']:
                              ...
                              if status == False:
                                   ...
                                   dispatcher.bot.sendMessage(Owner, "âš  Warning: user `{}` was detected spam.".format(user_id), parse_mode="markdown")
     ...
     if check_spam['status']:
          if check_user['status_hard']:
               ...
               if message.chat.type != 'private':
                    ...
                    return True
          dispatcher.bot.sendMessage(chat_id, "Hi!\nThe system has found that you were spamming commands recently !\n\nYou will be restricted for a while.\n\nIf you still continue to spam you will be banned.", reply_to_message_id=message.message_id)
          return True
