...
async def _(event):
    ...
    if pvoty is False and quizy==False and mchoicee==False:      
    ...
    if pvoty is True and quizy==False and mchoicee==True:      
     await tbot.send_file(event.chat_id, types.InputMediaPoll(
      poll=types.Poll(
        id=12345,
        question=ques,
    ...
    if pvoty is False and quizy==False and mchoicee==True:      
     await tbot.send_file(event.chat_id, types.InputMediaPoll(
      poll=types.Poll(
        id=12345,
        question=ques,
    ...
    if pvoty is True and quizy==False and mchoicee==False:      
     await tbot.send_file(event.chat_id, types.InputMediaPoll(
      poll=types.Poll(
        id=12345,
        question=ques,
    ...
    if pvoty is False and quizy==True and mchoicee==False:
     await tbot.send_file(event.chat_id, types.InputMediaPoll(
      poll=types.Poll(
        id=12345,
        question=ques,
    ...
    if pvoty is True and quizy==True and mchoicee==False:
     await tbot.send_file(event.chat_id, types.InputMediaPoll(
      poll=types.Poll(
        id=12345,
        question=ques,
    ...
    if pvoty is True and quizy==True and mchoicee==True:
       await event.reply("You can't use multiple voting with quiz mode")
       return
    if pvoty is False and quizy==True and mchoicee==True:
       await event.reply("You can't use multiple voting with quiz mode")
       return
